...
export function createCli(): Command {
  ...
  program
    .name("thoth")
    .description("Thoth CLI - control your AI coding agents from the command line")
  ...
  addJsonOption(
    program
      .command("status")
      .description('Show local daemon status (alias for "thoth daemon status")'),
  )
  ...
  addJsonOption(
    program
      .command("restart")
      .description('Restart local daemon (alias for "thoth daemon restart")'),
  )
    .option("--home <path>", "Thoth home directory (default: ~/.thoth)")
