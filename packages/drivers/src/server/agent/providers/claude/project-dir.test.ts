...
} from "@thoth/drivers/internal/server/agent/providers/claude/project-dir";
...
const workspaceRoot = join(homedir(), ".thoth-claude-parity-tests");
const tmpWorkspaceRoot = join(tmpdir(), "thoth-claude-parity");
