...
import { toReadToolDetail } from "@thoth/drivers/internal/server/agent/providers/tool-call-detail-primitives";
import { stripReadLineNumberGutter } from "@thoth/drivers/internal/server/agent/providers/tool-call-mapper-utils";
