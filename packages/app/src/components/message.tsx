...
const WEB_TOOLCALL_SHIMMER_KEYFRAME_ID = "thoth-toolcall-shimmer-keyframes";
const WEB_TOOLCALL_SHIMMER_ANIMATION_NAME = "thoth-toolcall-shimmer";
...
const WEB_TOOLCALL_SHIMMER_KEYFRAME_CSS = `
  @keyframes ${WEB_TOOLCALL_SHIMMER_ANIMATION_NAME} {
    0% {
      background-position: var(--thoth-shimmer-start, -200px) 0;
    }
    100% {
      background-position: var(--thoth-shimmer-end, 200px) 0;
    }
  }
`;
...
function buildShimmerTextStyle(input: {
  ...
  return {
    ...
    "--thoth-shimmer-start": `${input.webShimmerTrackStart - input.offsetX}px`,
    "--thoth-shimmer-end": `${input.webShimmerTrackEnd - input.offsetX}px`,
  };
}
