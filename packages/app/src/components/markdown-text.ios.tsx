...
export function MarkdownTextSpan({
  ...
  // Every selectable span installs a UIKit UITextView gesture recognizer. Large tables otherwise
  // fan each touch out across every cell, so table text stays readable but deliberately plain.
