export const en = {
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Let Thoth start and stop the built-in daemon",
        ...
        pausedStopFailed:
          "Built-in daemon management was paused, but Thoth could not stop the daemon.",
      ...
      fullStatus: {
        ...
        hint: "Runs `thoth daemon status` and shows the output",
        view: "View status",
    ...
    rosetta: {
      ...
      runningIntel: "You're running the Intel build of Thoth under Rosetta on Apple Silicon.",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Unable to install the Thoth CLI.",
      },
      skills: {
  ...
  pairing: {
    ...
    direct: {
      title: "Direct connection",
      helper: "Enter the address of a Thoth server.",
      fields: {
        host: "Host",
        port: "Port",
        password: "Password",
    ...
    device: {
      ...
      hint: "Scan this QR code with Thoth on your phone, or copy the link below.",
  ...
  settings: {
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "This updates Thoth on this computer",
    ...
    integrations: {
      ...
      skills: {
        ...
        updateTitle: "Update Thoth skills?",
        updateFallback: "Sync bundled skills to your machine.",
        uninstallTitle: "Uninstall Thoth skills?",
        uninstallMessage:
          "Removes all Thoth orchestration skills from ~/.agents, ~/.claude, ~/.codex.",
      },
      actions: {
        install: "Install",
        installing: "Installing...",
    ...
    host: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "This host is offline. Thoth reconnects automatically-wait until it's back online before restarting.",
          requestFailedTitle: "Error",
          requestFailedMessage:
            "Failed to send the restart request. Thoth reconnects automatically-try again once the host shows as online.",
    ...
    project: {
      ...
      readFailures: {
        invalidTitle: "thoth.json couldn't be parsed",
        ...
        transportTitle: "Couldn't load thoth.json",
        transportFallback: "The host didn't respond.",
        failedTitle: "Couldn't load thoth.json",
      ...
      scripts: {
        ...
        serviceHint: "Thoth supervises the process and assigns a port via $THOTH_PORT",
        actions: {
          add: "Add script",
          edit: "Edit",
          remove: "Remove",
      ...
      metadata: {
        ...
        info: "Project-specific instructions injected into the AI prompts Thoth uses to generate metadata - use them to enforce your team's conventions like branch naming, commit style, or PR format",
      ...
      writeFailures: {
        ...
        staleDescription: "Reload to fetch the latest thoth.json before saving.",
        failedTitle: "Couldn't save thoth.json",
