...
export const zhCN: TranslationResources = {
  ...
  agentControls: {
    ...
    thinking: {
      ...
      select: "选择 Clarify 级别",
      selectWithValue: "选择 Clarify 级别（{{value}}）",
    },
    model: {
      unknown: "未知 Model",
    },
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree: "此处无法归档，因为此 workspace 不是作为 Thoth worktree 创建的",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        title: "管理内置 daemon",
        hint: "让 Thoth 启动和停止内置 daemon",
        pauseTitle: "暂停内置 daemon",
        pauseMessage:
          "这会立即停止内置 daemon。连接到内置 daemon 的运行中 agents 和 terminals 会被停止。",
        pauseAndStop: "暂停并停止",
        registrationFailed:
          "内置 daemon 已启动，但 Thoth 无法保存 localhost 连接。请关闭后重新开启 daemon 管理，或手动添加 localhost。",
        pausedStopFailed: "内置 daemon 管理已暂停，但 Thoth 无法停止 daemon。",
      ...
      fullStatus: {
        ...
        hint: "运行 `thoth daemon status` 并显示输出",
        view: "查看状态",
        copied: "状态已复制到剪贴板。",
    ...
    rosetta: {
      ...
      runningIntel: "你正在 Apple Silicon 上通过 Rosetta 运行 Thoth 的 Intel 构建。",
  ...
  pairing: {
    ...
    device: {
      ...
      hint: "用手机上的 Thoth 扫描此二维码，或复制下方链接。",
  ...
  settings: {
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "这会更新此电脑上的 Thoth",
        installConfirm: "安装更新",
        update: "更新",
    ...
    integrations: {
      ...
      skills: {
        ...
        updateTitle: "更Thoth skills？",
        updateFallback: "将内置 skills 同步到你的机器。",
        uninstallTitle: "卸载 Thoth skills？",
        uninstallMessage: "会从 ~/.agents、~/.claude、~/.codex 移除所有 Thoth 编排 skills。",
      },
      actions: {
        install: "安装",
        installing: "正在安装...",
    ...
    host: {
      ...
      orchestration: {
        ...
        enableTools: {
          title: "启用 Thoth tools",
          hint: "Agent 将能够管理 worktree、Agent 和计划",
          accessibilityLabel: "注入 Thoth tools",
        },
        systemPrompt: {
          title: "System prompt",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage: "这个 Host 已离线。Thoth 会自动重连，请等它恢复在线后再重启。",
          requestFailedTitle: "错误",
          requestFailedMessage: "发送重启请求失败。Thoth 会自动重连，请在 Host 显示在线后重试。",
    ...
    project: {
      ...
      readFailures: {
        ...
        transportTitle: "无法加载 thoth.json",
        transportFallback: "Host 没有响应。",
        failedTitle: "无法加载 thoth.json",
      ...
      scripts: {
        ...
        editScript: "编辑 {{name}}",
        runAsService: "作为服务运行",
        serviceHint: "Thoth 会监管该进程，并通过 $THOTH_PORT 分配端口",
        actions: {
          add: "添加 script",
          edit: "编辑",
          remove: "移除",
      ...
      metadata: {
        title: "元数据生成",
        info: "注入到 Thoth 用来生成元数据的 AI prompts 中的 Project 专属指令，可用于强制执行团队约定，例如分支命名、提交风格或 PR 格式",
        branchName: "分支名称",
      ...
      writeFailures: {
        ...
        staleDescription: "保存前请重新加载最新的 thoth.json。",
        failedTitle: "无法保存 thoth.json",
