...
export const fr: TranslationResources = {
  ...
  workspace: {
    ...
    scripts: {
      ...
      accessibility: {
        ...
        stopScript: "Arrêter le script {{scriptName}}",
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "L'archive n'est pas disponible ici car cet espace de travail n'a pas été créé en tant qu'arbre de travailThoth",
          mergePrNoGithub:
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        newWorkspace: "Nouvel espace de travail",
        pinWorkspace: "Épingler ou désépingler l’espace de travail",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "LaissezThothdémarrer et arrêter le démon intégré",
        ...
        registrationFailed:
          "Built-in daemon started, but Thoth could not save the localhost connection. Toggle daemon management off and on again, or add localhost manually.",
        pausedStopFailed:
          "La gestion du démon intégré a été suspendue, maisThothn'a ​​pas pu arrêter le démon.",
      ...
      keepRunning: {
        ...
        hint: "Laissez cette option activée pour que les tâches et les planifications continuent après avoir quitté Thoth. La désactiver arrête les tâches planifiées et en arrière-plan.",
      },
      logs: {
      ...
      fullStatus: {
        ...
        hint: "Exécute`thoth daemon status`et affiche la sortie",
    ...
    rosetta: {
      ...
      runningIntel: "Vous exécutez la versionInteldeThothsousRosettasurApple Silicon.",
      highCpu:
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Impossible d'installer leThothCLI.",
      },
      skills: {
  ...
  pairing: {
    ...
    direct: {
      title: "Connexion directe",
      helper: "Saisissez l'adresse d'un serveurThoth.",
      fields: {
        host: "Host",
        port: "Port",
    ...
    device: {
      ...
      hint: "Scannez ce codeQRavecThothsur votre téléphone ou copiez le lien ci-dessous.",
  ...
  settings: {
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Cela met à jourThothsur cet ordinateur",
    ...
    integrations: {
      ...
      skills: {
        ...
        updateTitle: "Mettre à jour les compétencesThoth?",
        updateFallback: "Synchronisez les compétences regroupées sur votre machine.",
        uninstallTitle: "Désinstaller les compétencesThoth?",
        uninstallMessage:
          "Supprime toutes les compétences d'orchestrationThothde ~/.agents, ~/.claude, ~/.codex.",
      },
      actions: {
        install: "Installer",
        installing: "Installation...",
    ...
    host: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Cet hôte est hors ligne.Thothse reconnecte automatiquement: attendez qu'il soit de nouveau en ligne avant de redémarrer.",
          requestFailedTitle: "Erreur",
          requestFailedMessage:
            "Échec de l'envoi de la demande de redémarrage.Thothse reconnecte automatiquement - réessayez une fois que l'hôte apparaît comme en ligne.",
          dialogFailedMessage:
    ...
    project: {
      ...
      readFailures: {
        invalidTitle: "thoth.json n'a pas pu être analysé",
        ...
        transportTitle: "Impossible de charger thoth.json",
        transportFallback: "L'hôte n'a pas répondu.",
        failedTitle: "Impossible de charger thoth.json",
      ...
      scripts: {
        ...
        serviceHint: "Thothsupervise le processus et attribue un port via $THOTH_PORT",
        actions: {
      ...
      metadata: {
        ...
        info: "Instructions spécifiques au projet injectées dans les invites de l'IA queThothutilise pour générer des métadonnées: utilisez-les pour appliquer les conventions de votre équipe telles que la dénomination des branches, le style de validation ou le formatPR.",
      ...
      writeFailures: {
        ...
        staleDescription: "Rechargez pour récupérer le dernier thoth.json avant de sauvegarder.",
        failedTitle: "Impossible d'enregistrer thoth.json",
