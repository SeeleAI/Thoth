...
export const ar: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "الأرشيف غير متاح هنا لأنه لم يتم إنشاء مساحة العمل هذه كشجرة عمل Thoth",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "اسمح لـ Thoth ببدء تشغيل البرنامج الخفي المدمج وإيقافه",
        ...
        pausedStopFailed:
          "تم إيقاف إدارة البرنامج الخفي المضمنة مؤقتًا، لكن لم يتمكن Thoth من إيقاف البرنامج الخفي.",
      ...
      fullStatus: {
        ...
        hint: "يقوم بتشغيل`thoth daemon status`ويظهر الإخراج",
        view: "عرض الحالة",
    ...
    rosetta: {
      ...
      runningIntel: "أنت تقوم بتشغيل إصدار Intel من Thoth ضمن Rosetta على Apple Silicon.",
      highCpu:
    ...
    integrations: {
      cli: {
        ...
        installFailed: "غير قادر على تثبيت ThothCLI.",
      },
      skills: {
  ...
  pairing: {
    ...
    device: {
      ...
      hint: "قم بمسح رمز QR هذا باستخدام Thoth على هاتفك، أو انسخ الرابط أدناه.",
  ...
  settings: {
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "يؤدي هذا إلى تحديث Thoth على هذا الكمبيوتر",
    ...
    integrations: {
      ...
      skills: {
        ...
        updateTitle: "تحديث مهارات Thoth ؟",
        updateFallback: "مزامنة المهارات المجمعة لجهازك.",
        uninstallTitle: "إلغاء تثبيت مهارات Thoth ؟",
        uninstallMessage: "يزيل جميع مهارات تنسيق Thoth من ~/.agents ، ~/.claude ، ~/.codex.",
      },
      actions: {
        install: "ثَبَّتَ",
        installing: "جارٍ التثبيت...",
    ...
    host: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "هذا المضيف غير متصل.  يقوم Thoth بإعادة الاتصال تلقائيًا - انتظر حتى يتم الاتصال بالإنترنت مرة أخرى قبل إعادة التشغيل.",
          requestFailedTitle: "خطأ",
          requestFailedMessage:
            "فشل في إرسال طلب إعادة التشغيل.  يقوم Thoth بإعادة الاتصال تلقائيًا - حاول مرة أخرى بمجرد ظهور المضيف على أنه متصل بالإنترنت.",
    ...
    project: {
      ...
      readFailures: {
        invalidTitle: "تعذر تحليل thoth.json",
        ...
        transportTitle: "تعذر تحميل thoth.json",
        transportFallback: "المضيف لم يستجب.",
        failedTitle: "تعذر تحميل thoth.json",
      ...
      scripts: {
        ...
        serviceHint: "يشرف Thoth على العملية ويعين منفذًا عبر $THOTH_PORT",
        actions: {
      ...
      metadata: {
        ...
        info: "تعليمات خاصة بالمشروع يتم إدخالها في الذكاء الاصطناعي الذي يستخدمه Thoth لإنشاء بيانات التعريف - استخدمها لفرض اصطلاحات فريقك مثل تسمية الفرع أو نمط الالتزام أو تنسيق PR",
      ...
      writeFailures: {
        ...
        staleDescription: "أعد التحميل لجلب أحدث ملف thoth.json قبل الحفظ.",
        failedTitle: "تعذر حفظ thoth.json",
