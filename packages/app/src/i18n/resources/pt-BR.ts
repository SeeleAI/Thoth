...
export const ptBR: TranslationResources = {
  ...
  workspace: {
    ...
    scripts: {
      ...
      accessibility: {
        ...
        stopScript: "Parar script {{scriptName}}",
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "Arquivar não está disponível aqui porque este workspace não foi criado como um worktree do Thoth",
          mergePrNoGithub:
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        newWorkspace: "Novo workspace",
        pinWorkspace: "Fixar ou desafixar workspace",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Permitir que o Thoth inicie e pare o daemon integrado",
        ...
        registrationFailed:
          "O daemon integrado foi iniciado, mas o Thoth não conseguiu salvar a conexão localhost. Desative e reative o gerenciamento do daemon ou adicione localhost manualmente.",
        pausedStopFailed:
          "O gerenciamento do daemon integrado foi pausado, mas o Thoth não conseguiu parar o daemon.",
        updateFailed: "Não foi possível atualizar o gerenciamento do daemon integrado.",
      },
      keepRunning: {
        title: "Manter daemon em execução ao sair",
        hint: "Mantenha esta opção ativada para que tarefas e agendamentos continuem após sair do Thoth. Desativá-la interrompe tarefas agendadas e em segundo plano ao sair.",
      },
      logs: {
      ...
      fullStatus: {
        ...
        hint: "Executa `thoth daemon status` e mostra a saída",
        view: "Ver status",
    ...
    rosetta: {
      ...
      runningIntel: "Você está executando a build Intel do Thoth pelo Rosetta no Apple Silicon.",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Não foi possível instalar a CLI do Thoth.",
      },
      skills: {
  ...
  pairing: {
    ...
    direct: {
      title: "Conexão direta",
      helper: "Informe o endereço de um servidor Thoth.",
      fields: {
        host: "Host",
        port: "Porta",
        password: "Senha",
    ...
    device: {
      ...
      hint: "Escaneie este QR code com o Thoth no seu celular ou copie o link abaixo.",
  ...
  settings: {
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Isso atualiza o Thoth neste computador",
    ...
    integrations: {
      ...
      skills: {
        ...
        updateTitle: "Atualizar Thoth skills?",
        updateFallback: "Sincronize as skills incluídas com sua máquina.",
        uninstallTitle: "Desinstalar Thoth skills?",
        uninstallMessage:
          "Remove todas as skills de orquestração do Thoth de ~/.agents, ~/.claude e ~/.codex.",
      },
      actions: {
        install: "Instalar",
        installing: "Instalando...",
    ...
    host: {
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Ativar ferramentas do Thoth",
          hint: "Agentes poderão gerenciar worktrees, agentes e agendamentos",
          accessibilityLabel: "Injetar ferramentas do Thoth",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Este host está offline. O Thoth reconecta automaticamente. Aguarde ele voltar a ficar online antes de reiniciar.",
          requestFailedTitle: "Erro",
          requestFailedMessage:
            "Falha ao enviar a solicitação de reinício. O Thoth reconecta automaticamente. Tente novamente quando o host aparecer como online.",
    ...
    project: {
      ...
      readFailures: {
        invalidTitle: "Não foi possível analisar thoth.json",
        ...
        transportTitle: "Não foi possível carregar thoth.json",
        transportFallback: "O host não respondeu.",
        failedTitle: "Não foi possível carregar thoth.json",
      ...
      scripts: {
        ...
        serviceHint: "O Thoth supervisiona o processo e atribui uma porta via $THOTH_PORT",
        actions: {
      ...
      metadata: {
        ...
        info: "Instruções específicas do projeto injetadas nos prompts de IA que o Thoth usa para gerar metadados. Use-as para aplicar convenções da sua equipe, como nomes de branch, estilo de commit ou formato de PR",
      ...
      writeFailures: {
        ...
        staleDescription: "Recarregue para buscar o thoth.json mais recente antes de salvar.",
        failedTitle: "Não foi possível salvar thoth.json",
