...
export const es: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "El archivo no está disponible aquí porque este espacio de trabajo no se creó como un árbol de trabajoThoth",
          mergePrNoGithub:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Deje queThothinicie y detenga el demonio incorporado",
        ...
        pausedStopFailed:
          "La gestión del demonio integrado se pausó, peroThothno pudo detener el demonio.",
      ...
      fullStatus: {
        ...
        hint: "Ejecuta`thoth daemon status`y muestra la salida.",
        view: "Ver estado",
    ...
    rosetta: {
      ...
      runningIntel: "Estás ejecutando la compilaciónInteldeThothenRosettaenApple Silicon.",
      highCpu:
    ...
    integrations: {
      cli: {
        ...
        installFailed: "No se puede instalar elThothCLI.",
      },
      skills: {
  ...
  pairing: {
    ...
    direct: {
      title: "Conexión directa",
      helper: "Ingrese la dirección de un servidorThoth.",
      fields: {
        host: "Host",
        port: "Puerto",
        password: "Contraseña",
    ...
    device: {
      ...
      hint: "Escanee este códigoQRconThothen su teléfono o copie el enlace a continuación.",
  ...
  settings: {
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Esto actualizaThothen esta computadora.",
    ...
    integrations: {
      ...
      skills: {
        ...
        updateTitle: "¿Actualizar las habilidades deThoth?",
        updateFallback: "Sincronice las habilidades incluidas con su máquina.",
        uninstallTitle: "¿Desinstalar las habilidadesThoth?",
        uninstallMessage:
          "Elimina todas las habilidades de orquestaciónThothde ~/.agents, ~/.claude, ~/.codex.",
      },
      actions: {
        install: "Instalar",
        installing: "Instalando...",
    ...
    host: {
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Habilitar herramientasThoth",
          hint: "Los agentes podrán gestionar árboles de trabajo, agentes y horarios.",
          accessibilityLabel: "Inyectar herramientasThoth",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Este anfitrión está desconectado.Thothse vuelve a conectar automáticamente; espere hasta que vuelva a estar en línea antes de reiniciar.",
          requestFailedTitle: "Error",
          requestFailedMessage:
            "No se pudo enviar la solicitud de reinicio.Thothse vuelve a conectar automáticamente; inténtelo nuevamente una vez que el host se muestre en línea.",
          dialogFailedMessage:
    ...
    project: {
      ...
      readFailures: {
        invalidTitle: "thoth.json no se pudo analizar",
        ...
        transportTitle: "No se pudo cargar thoth.json",
        transportFallback: "El anfitrión no respondió.",
        failedTitle: "No se pudo cargar thoth.json",
      ...
      scripts: {
        ...
        serviceHint: "Thothsupervisa el proceso y asigna un puerto vía $THOTH_PORT",
        actions: {
          add: "Agregar guión",
          edit: "Editar",
          remove: "Eliminar",
      ...
      metadata: {
        ...
        info: "Instrucciones específicas del proyecto inyectadas en los mensajes de IA queThothutiliza para generar metadatos; úselas para hacer cumplir las convenciones de su equipo, como la denominación de ramas, el estilo de confirmación o el formatoPR.",
      ...
      writeFailures: {
        ...
        staleDescription: "Vuelva a cargar para obtener el último thoth.json antes de guardar.",
        failedTitle: "No se pudo guardar thoth.json",
