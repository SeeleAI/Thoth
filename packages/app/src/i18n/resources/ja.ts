...
export const ja: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "このワークスペースはThothワークツリーとして作成されていないため、アーカイブはここでは利用できません",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        title: "組み込みデーモンを管理",
        hint: "Thothが組み込みデーモンを起動・停止できるようにする",
        pauseTitle: "組み込みデーモンを一時停止",
        pauseMessage:
          "これにより組み込みデーモンが即座に停止します。組み込みデーモンに接続されている実行中のエージェントとターミナルが停止されます。",
        pauseAndStop: "一時停止して停止",
        registrationFailed:
          "組み込みデーモンは起動しましたが、Thothがlocalhostの接続を保存できませんでした。デーモン管理をオフにしてから再度オンにするか、localhostを手動で追加してください。",
        pausedStopFailed:
          "組み込みデーモン管理は一時停止されましたが、Thothがデーモンを停止できませんでした。",
      ...
      fullStatus: {
        ...
        hint: "`thoth daemon status`を実行して出力を表示します",
        view: "ステータスを表示",
    ...
    rosetta: {
      ...
      runningIntel: "Apple Silicon上のRosettaでThothのIntelビルドを実行しています。",
      highCpu:
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Thoth CLIをインストールできません。",
      },
      skills: {
  ...
  pairing: {
    ...
    direct: {
      title: "直接接続",
      helper: "Thothサーバーのアドレスを入力してください。",
      fields: {
        host: "ホスト",
        port: "ポート",
        password: "パスワード",
    ...
    device: {
      ...
      hint: "スマートフォンのThothでこのQRコードをスキャンするか、以下のリンクをコピーしてください。",
  ...
  settings: {
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "このコンピューターのThothを更新します",
    ...
    integrations: {
      ...
      skills: {
        ...
        updateTitle: "Thothスキルを更新しますか？",
        updateFallback: "バンドルされたスキルをマシンに同期します。",
        uninstallTitle: "Thothスキルをアンインストールしますか？",
        uninstallMessage:
          "~/.agents、~/.claude、~/.codexからすべてのThothオーケストレーションスキルを削除します。",
      },
      actions: {
        install: "インストール",
        installing: "インストール中...",
    ...
    host: {
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Thothツールを有効にする",
          hint: "エージェントがワークツリー、エージェント、スケジュールを管理できるようになります",
          accessibilityLabel: "Thothツールを有効にする",
        },
        systemPrompt: {
          title: "システムプロンプト",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "このホストはオフラインです。Thothが自動再接続します。再起動は、ホストがオンラインに戻ってから行ってください。",
          requestFailedTitle: "エラー",
          requestFailedMessage:
            "再起動リクエストの送信に失敗しました。Thothは自動的に再接続します。ホストがオンラインになったら再試行してください。",
    ...
    project: {
      ...
      readFailures: {
        invalidTitle: "thoth.jsonを解析できませんでした",
        ...
        transportTitle: "thoth.jsonを読み込めませんでした",
        transportFallback: "ホストが応答しませんでした。",
        failedTitle: "thoth.jsonを読み込めませんでした",
      ...
      scripts: {
        ...
        serviceHint: "Thothがプロセスを監督し、$THOTH_PORTを通じてポートを割り当てます",
        actions: {
          add: "スクリプトを追加",
          edit: "編集",
          remove: "削除",
      ...
      metadata: {
        title: "メタデータ生成",
        info: "Thothがメタデータ生成に使うAIプロンプトへ追加する、プロジェクト固有の指示です。ブランチ名、コミット形式、PR形式など、チームの規約を反映するために使います。",
        branchName: "ブランチ名",
      ...
      writeFailures: {
        ...
        staleDescription: "保存する前に最新のthoth.jsonを取得するために再読み込みしてください。",
        failedTitle: "thoth.jsonを保存できませんでした",
