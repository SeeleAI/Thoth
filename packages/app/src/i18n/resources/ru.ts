...
export const ru: TranslationResources = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "Архив здесь недоступен, поскольку это рабочее пространство не было создано как рабочее дерево Thoth.",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Позвольте Thoth запустить и остановить встроенный демон.",
        ...
        pausedStopFailed:
          "Встроенное управление демоном было приостановлено, но Thoth не смог остановить демон.",
      ...
      fullStatus: {
        ...
        hint: "Запускает`thoth daemon status`и показывает результат",
    ...
    rosetta: {
      ...
      runningIntel: "Вы используете сборку Intel для Thoth под Rosetta на Apple Silicon.",
      highCpu:
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Невозможно установить ThothCLI.",
      },
      skills: {
  ...
  onboarding: {
    title: "Добро пожаловать в Thoth",
  ...
  pairing: {
    ...
    direct: {
      title: "Прямое подключение",
      helper: "Введите адрес сервера Thoth.",
      fields: {
        host: "Host",
        port: "Порт",
        password: "Пароль",
    ...
    device: {
      ...
      hint: "Отсканируйте этот код QR с помощью Thoth на своем телефоне или скопируйте ссылку ниже.",
  ...
  settings: {
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Это обновит Thoth на этом компьютере.",
    ...
    integrations: {
      ...
      skills: {
        ...
        updateTitle: "Обновить навыки Thoth?",
        updateFallback: "Синхронизируйте связанные навыки с вашим компьютером.",
        uninstallTitle: "Удалить навыки Thoth?",
        uninstallMessage: "Удаляет все навыки оркестровки Thoth из ~/.agents, ~/.claude, ~/.codex.",
      },
      actions: {
        install: "Установить",
        installing: "Установка...",
    ...
    host: {
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Включить инструменты Thoth",
          hint: "Агенты смогут управлять рабочими деревьями, агентами и расписаниями.",
          accessibilityLabel: "Инструменты внедрения Thoth",
        },
        systemPrompt: {
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Этот хост не в сети.Thoth автоматически повторно подключается — подождите, пока он снова подключится к сети, прежде чем перезапускаться.",
          requestFailedTitle: "Ошибка",
          requestFailedMessage:
            "Не удалось отправить запрос на перезапуск.Thoth автоматически повторно подключается. Повторите попытку, как только хост окажется в сети.",
    ...
    project: {
      ...
      readFailures: {
        invalidTitle: "thoth.json не удалось разобрать",
        ...
        transportTitle: "Не удалось загрузить thoth.json.",
        transportFallback: "Хозяин не ответил.",
        failedTitle: "Не удалось загрузить thoth.json.",
      ...
      scripts: {
        ...
        serviceHint: "Thoth контролирует процесс и назначает порт через $THOTH_PORT.",
        actions: {
          add: "Добавить скрипт",
          edit: "Редактировать",
          remove: "Удалять",
      ...
      metadata: {
        ...
        info: "Инструкции для конкретного проекта, внедренные в подсказки ИИ, которые Thoth использует для генерации метаданных. Используйте их для обеспечения соблюдения соглашений вашей команды, таких как наименование ветвей, стиль фиксации или формат PR.",
      ...
      writeFailures: {
        ...
        staleDescription:
          "Перед сохранением перезагрузите компьютер, чтобы получить последнюю версию файла thoth.json.",
        failedTitle: "Не удалось сохранить thoth.json.",
