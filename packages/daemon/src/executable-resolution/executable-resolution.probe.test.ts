...
import { probeExecutable } from "@thoth/drivers/internal/executable-resolution/executable-resolution";
...
function makeTempDir(): string {
  const dir = mkdtempSync(path.join(os.tmpdir(), "thoth-probe-test-"));
  tempDirs.push(dir);
  return dir;
}
