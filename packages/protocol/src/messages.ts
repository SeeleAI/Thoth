...
import {
  ...
  ThothMetadataGenerationEntrySchema,
  ThothMetadataGenerationSchema,
  ...
  type ThothMetadataGeneration,
  type ThothMetadataGenerationEntry,
...
const MutableProviderControlConfigSchema = z
  .object({
    runMode: ProviderRunModeSchema.optional(),
  })
  .strict();
...
export const MutableDaemonConfigSchema = z
  .object({
    ...
    providerControl: MutableProviderControlConfigSchema.default({}),
...
export const MutableDaemonConfigPatchSchema = z
  .object({
    ...
    providerControl: MutableProviderControlConfigSchema.partial().optional(),
...
export const ReviewAttachmentSchema = z.object({
  ...
  mimeType: z.literal("application/thoth-review"),
  cwd: z.string(),
...
export const WriteProjectConfigRequestMessageSchema = z.object({
  ...
  requestId: z.string(),
  repoRoot: z.string(),
  config: ThothConfigRawSchema,
  expectedRevision: ThothConfigRevisionSchema.nullable(),
});
...
export const StashListRequestSchema = z.object({
  ...
  cwd: z.string(),
  /** If true, only return thoth-created stashes. Default true. */
  thothOnly: z.boolean().optional(),
  requestId: z.string(),
});
...
export const ThothWorktreeListRequestSchema = z.object({
  type: z.literal("thoth_worktree_list_request"),
  cwd: z.string().optional(),
  repoRoot: z.string().optional(),
  requestId: z.string(),
});

export const ThothWorktreeArchiveRequestSchema = z.object({
  type: z.literal("thoth_worktree_archive_request"),
  ...
  // Thoth-owned. Omitted/unknown values default to "workspace" for old-client safety.
...
export const CreateThothWorktreeRequestSchema = z.object({
  type: z.literal("create_thoth_worktree_request"),
  cwd: z.string(),
  projectId: z.string().optional(),
  worktreeSlug: z.string().optional(),
...
// between an existing local directory and a newly created thoth worktree.
...
export const ServerCapabilitiesSchema = z.object({}).passthrough();
...
export const ProjectCheckoutLiteNotGitPayloadSchema = z
  .object({
    ...
    isThothOwnedWorktree: z.literal(false),
    mainRepoRoot: z.null(),
  })
  .transform((value) => ({
    ...value,
...
export const ProjectCheckoutLiteGitNonThothPayloadSchema = z
  .object({
    cwd: z.string(),
...
export const ProjectCheckoutLiteGitThothPayloadSchema = z
  .object({
    cwd: z.string(),
    isGit: z.literal(true),
    currentBranch: z.string().nullable(),
    remoteUrl: z.string().nullable(),
    worktreeRoot: z.string().optional(),
    isThothOwnedWorktree: z.literal(true),
...
export const ProjectCheckoutLitePayloadSchema = z.union([
  ...
  ProjectCheckoutLiteGitNonThothPayloadSchema,
  ProjectCheckoutLiteGitThothPayloadSchema,
]);
...
export const FetchAgentResponseMessageSchema = z.object({
  ...
  payload: z.object({
    ...
    project: ProjectPlacementPayloadSchema.nullable().optional(),
    error: z.string().nullable(),
    errorCode: z.literal("agent_not_found").nullable().optional(),
  }),
});
...
export const ReadProjectConfigResponseMessageSchema = z.object({
  ...
  payload: z.discriminatedUnion("ok", [
    z.object({
      ...
      repoRoot: z.string(),
      ok: z.literal(true),
      config: ThothConfigRawSchema.nullable(),
      revision: ThothConfigRevisionSchema.nullable(),
    }),
    z.object({
      requestId: z.string(),
      repoRoot: z.string(),
...
export const WriteProjectConfigResponseMessageSchema = z.object({
  ...
  payload: z.discriminatedUnion("ok", [
    z.object({
      ...
      ok: z.literal(true),
      config: ThothConfigRawSchema,
      revision: ThothConfigRevisionSchema,
    }),
    z.object({
      requestId: z.string(),
      repoRoot: z.string(),
...
const CheckoutStatusGitNonThothSchema = CheckoutStatusCommonSchema.extend({
  isGit: z.literal(true),
  isThothOwnedWorktree: z.literal(false),
  repoRoot: z.string(),
  mainRepoRoot: z.string().nullable().optional().default(null),
...
const CheckoutStatusGitThothSchema = CheckoutStatusCommonSchema.extend({
  isGit: z.literal(true),
  isThothOwnedWorktree: z.literal(true),
  repoRoot: z.string(),
  mainRepoRoot: z.string(),
...
export const CheckoutStatusResponseSchema = z.object({
  ...
  payload: z.union([
    ...
    CheckoutStatusGitNonThothSchema,
    CheckoutStatusGitThothSchema,
  ]),
});
...
const ThothWorktreeSchema = z.object({
  worktreePath: z.string(),
  createdAt: z.string(),
...
export const ThothWorktreeListResponseSchema = z.object({
  type: z.literal("thoth_worktree_list_response"),
  payload: z.object({
    worktrees: z.array(ThothWorktreeSchema),
    error: CheckoutErrorSchema.nullable(),
    requestId: z.string(),
  }),
});

export const ThothWorktreeArchiveResponseSchema = z.object({
  type: z.literal("thoth_worktree_archive_response"),
  payload: z.object({
    success: z.boolean(),
...
export const CreateThothWorktreeResponseSchema = z.object({
  type: z.literal("create_thoth_worktree_response"),
  payload: z.object({
    workspace: WorkspaceDescriptorPayloadSchema.nullable(),
    error: z.string().nullable(),
    errorCode: z.string().optional(),
...
export type CreateThothWorktreeRequest = z.infer<typeof CreateThothWorktreeRequestSchema>;
...
export type ThothWorktreeListRequest = z.infer<typeof ThothWorktreeListRequestSchema>;
export type ThothWorktreeListResponse = z.infer<typeof ThothWorktreeListResponseSchema>;
export type ThothWorktreeArchiveRequest = z.infer<typeof ThothWorktreeArchiveRequestSchema>;
export type ThothWorktreeArchiveResponse = z.infer<typeof ThothWorktreeArchiveResponseSchema>;
