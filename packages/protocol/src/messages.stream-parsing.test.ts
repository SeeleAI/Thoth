        ...
        entries: [
          {
            ...
            item: {
              ...
              detail: {
                type: "worktree_setup",
                worktreePath: "/repo/.thoth/worktrees/feature",
                branchName: "feature",
                log: "setup complete",
                commands: [
                  {
                    index: 1,
                    command: "npm install",
                    cwd: "/repo/.thoth/worktrees/feature",
                    status: "completed",
                    exitCode: 0,
                    durationMs: 100,
                  },
          ...
          item: {
            ...
            card: {
              ...
              card: {
                title: "确认方向",
                whyNow: "路线会影响验收。",
                publicSummary: "确认两个相关的交付分叉。",
                questions: [
                  {
                    nodeId: "delivery-path/scope",
                    question: "优先哪条路线？",
                    choices: [
  ...
  it("parses directory suggestions request and response payloads", () => {
    ...
    const responseParsed = SessionOutboundMessageSchema.safeParse({
      ...
      payload: {
        ...
        entries: [{ path: "/Users/test/projects/thoth", kind: "directory" }],
        error: null,
        requestId: "req-dir-1",
      },
    });
