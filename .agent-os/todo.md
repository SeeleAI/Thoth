...
1. `NTH-TD-048` `[doing]`: Organically integrate the approved capabilities and bug fixes in exact Paseo range `5fc53c57..b589599a`, verify every upstream commit and architecture candidate, and replace the fixed desktop-only MVP Beta from one exact source SHA.
   - Scope: adapt Forge/Workspace lifecycle, Browser automation/profile, Workspace-owned Schedule, canonical Timeline/subagent/idle semantics, Provider portfolio/default/delete, persistent service-port leases, Desktop/Daemon/Terminal lifecycle, read-only Files/Changes and confirmed App/Mobile regressions through current Thoth owners; reject voice/Hub/website/legacy authority/distribution and defer file editing.
   - Acceptance: `NTH-AC-025`; provenance `393/393`, architecture candidates `143/143`, required architectural candidates `43/43`, zero pending reviews/failures; all affected and root gates plus real Web, local Android Debug APK and AppImage journeys pass; exact-SHA Actions replaces `v0.0.0-mvp-beta` with exactly 26 desktop-only public assets and downloaded public verification passes without changing `main`, Relay deployment or Paseo `6767`.
   - Current result: the first exact-SHA workflow `30282306284` failed before publish because clean packaged Desktop homes created the legitimate non-authority `desktop-attachments/` directory before storage migration. The old 26-asset Release remains intact. A failing characterization test and one-entry allowlist repair now pass Daemon `2,512`, Foundation `655`, the rebuilt real-window AppImage journey and the shared `152.842s` refactor gate. The corrective local candidate is `release_ready`; production is `310,933` LOC with approved `DeltaP=14,496`, while corrective publication and public-download reverification remain pending.
   - Related: `NTH-REQ-028`, `NTH-AC-025`, `NTH-CD-076`, `NTH-CD-077`, `NTH-CD-078`, `NTH-CD-079`, `NTH-CD-080`, `NTH-CD-081`, `NTH-CD-082`, `NTH-CD-083`, `NTH-CD-084`, `NTH-CD-085`, `NTH-CD-086`, `NTH-CD-087`, `NTH-CD-088`, `NTH-EV-071`
